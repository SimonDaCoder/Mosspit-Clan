...
export const GradientButton = ({
  ...
  return (
    <button
      onClick={onClick}
      className="relative rounded-2xl p-px transition-transform active:scale-95"
    >
      {/* Gradient Border */}
      <span className="absolute inset-0 rounded-2xl bg-linear-to-bl from-emerald-400/40 via-emerald-300/10 to-transparent transition-all duration-300 group-hover:from-emerald-500/50 group-hover:via-emerald-400/30" />
